			...
			<div id="topTabs-container-home">
				<div class="topTabs-header clearfix">
					...
					<div class="secInfo sec-dashboard">
						<h1 class="secTitle">Data Ditolak</h1>
						<span class="secExtra">Tabel daftar seluruh data yang ditolak:</span>
					</div> <!-- /SecInfo -->
				...
				<!-- <div class="widget-content pad20f">	
					<div class="alert alert-info" role="alert">
						<strong><i class="fa fa-info-circle"></i> Informasi!</strong> Tabel diatas memuat semua data SPPSB yang telah ditolak oleh staff ataupun direksi
					</div>
				</div> -->
			</div>
		</div> <!-- /fluid -->
...
@push('scripts')
	...
	$(document).ready(function() {
	    ...
	    $("#sppsb-datatable").DataTable({
	        processing: true,
	        serverSide: true,
	        ajax: '{{ url("/") }}/getdata-sppsb-ditolak',
	        columns: [
	            ...
	            { data: 'tgl_penolakan', name: 'tgl_penolakan', sClass:'text-center' },
	            { data: 'remark', name: 'alasan_penolakan' },
		...
		$("#sp3kbg-datatable").DataTable({
	        processing: true,
	        serverSide: true,
	        ajax: '{{ url("/") }}/getdata-sp3kbg-ditolak',
	        columns: [
	            { data: 'name', name: 'name',
	            	render: function ( data, type, row ) {
