	        	...
	        	<div id="tab1">					
                    <form id="sppsbForm" class="form-horizontal" action="{{ url('/sppsb-update') }}" method="POST">
						...
						@if(Auth::check())
							...
							<div class="form-group">
								<div class="col-sm-6">
									<a id="back" href="{{ url('/sppsb-data-table') }}" class="btn btn-dark-grey"><i class="fa fa-undo"></i> KEMBALI</a>
									<a id="print" href="{{ url('/cetak-detail') }}/{{ $sppsb->id }}" class="btn btn-lavender" target="blank"><i class="fa fa-print"></i> PRINT</a>
								</div>
