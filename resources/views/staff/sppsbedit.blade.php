            ...
            <div class="topTabs">					
                <div id="topTabs-container-edit">
                    ...
                    <div class="topTabsContent" style="padding-left:0;">
                        ...
                        <form id="sppsbForm" class="form-horizontal" method="POST" action="{{ url('/') }}/sppsb-edit-staff" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                                
                            <input type="hidden" id="sppsb_id" name="id" value="{{ $sppsb->sppsb_id }}">
                            <input type="hidden" id="spps_type" name="jenis" value="{{ old('jenis', $sppsb->jenis_sppsb) }}">
                              ...
                              <div id="history_penjaminan" class="@if (old('jenis')!='4') hide @endif">
                                    ...
                                    <div class="widget-content pad20f">
                                        ...
                                        <div id="pialang" class="form-group">
                                            ...
                                            <div class="col-sm-9"> 
                                                <div class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-blue btn-default @if (old('pialang')=='Ya'||$sppsb->dijaminan_jamkrida=='Ya') active @endif">
                                                        <input required="" id="telahdijamin" type="radio" name="pialang" value="Ya" @if (old('pialang')=='Ya'||$sppsb->dijaminan_jamkrida=='Ya') checked @endif autocomplete="off">
                                                               Ya
                                                    </label>
                                                    <label class="btn btn-red  btn-default @if (old('pialang')=='Tidak'||$sppsb->dijaminan_jamkrida=='Tidak') active @endif">
                                                        <input required="" id="belumdijamin" type="radio" name="pialang" value="Tidak" @if (old('pialang')=='Tidak'||$sppsb->dijaminan_jamkrida=='Tidak') checked @endif autocomplete="off">
                                                               Tidak
                                                    </label>
                                                </div>
                                        ...
                                        <div id="nomorsertifikat" class="form-group @if (old('pialang')!='Ya') hide @endif">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="input-group">
                                                    <input type="text" name="nomor_sertifikat" value="{{ old('nomor_sertifikat',$sppsb->no_sertifikat) }}" class="form-control text-right" id="nomor_sertifikat" placeholder="Masukkan Nomor Sertifikat">
                                        ...
                                        <div id="nama_pialang" class="form-group  form-group @if (old('pialang')=='Ya'||old('pialang')=='') hide @endif {{ $errors->has('nama_asuransi') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="nama_asuransi" value="{{ old('nama_asuransi',$sppsb->nama_asuransi) }}" class="form-control" id="nama_asuransi">
                                            </div>
                                        </div>
                                        ...
                                        <div id="deskripsi" class="form-group @if (old('pialang')=='Ya'||old('pialang')=='') hide @endif  {{ $errors->has('deskripsi') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="deskripsi" id="" rows="3">{{ old('deskripsi',$sppsb->deskripsi_singkat) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div id="pengerjaan" class="form-group @if (old('jenis')!='4') hide @endif">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-blue btn-default @if (old('pengerjaan_proyek')=='Ya'||$sppsb->penyelesaian_tepat=='Ya') active @endif">
                                                        <input id="" type="radio" name="pengerjaan_proyek" value="Ya" @if ($sppsb->penyelesaian_tepat=='Ya'||$sppsb->penyelesaian_tepat=='Ya') checked @endif autocomplete="off">
                                                               Ya
                                                    </label>
                                                    <label class="btn btn-red  btn-default @if (old('pengerjaan_proyek')=='Tidak'||$sppsb->penyelesaian_tepat=='Tidak') active @endif">
                                                        <input id="" type="radio" name="pengerjaan_proyek" value="Tidak"     @if (old('pengerjaan_proyek')=='Tidak'||$sppsb->penyelesaian_tepat=='Tidak') checked @endif   autocomplete="off">
                                                               Tidak
                                                    </label>
                                                </div>
                                                <span class="help-block"><small>silahkan klik salah satu tab untuk memilih (tab terpilih akan berubah warna menjadi abu-abu)</small></span>
                                        ...
                                        <div id="kendala" class="form-group  @if (old('pengerjaan_proyek')=='Ya'||old('pialang')=='') hide @endif {{ $errors->has('kendala') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="kendala" id="deskripsi_kendala" rows="3">{{ old('kendala',$sppsb->deskripsi_kendala) }}</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="widget-content pad20f">
                                    ...
                                    @if($pengalamanKontraktor!=null)
                                           @foreach($pengalamanKontraktor as $key => $item)
                                        <div id="pengalamanClone">
                                            <div id="cloneWrapperPengalaman">
                                                ...
                                                <div class="form-group {{ $errors->has('jenis_pekerjaan') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control clearClone" name="jenispekerjaan[]" rows="3">{{ old('jenis_pekerjaan',$item->jenispekerjaan) }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group {{ $errors->has('pemilik_proyek[]') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control clearClone" name="pemilikproyek[]" rows="3">{{ old('pemilik_proyek',$item->pemilikproyek) }}</textarea>
                                                ...
                                                <div class="form-group {{ $errors->has('no_dokumen[]') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="nodokumen[]" value="{{ old('nodokumen[]',$item->nodokumen) }}" class="form-control clearClone"  >
                                                    </div>
                                                </div>
                                                <div class="form-group {{ $errors->has('tgl_dokumen') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="input-group">
                                                            <input type="text" name="tgldokumen[]" value="{{ old('tgl_dokumen',$item->tgldokumen) }}" class="form-control  clearClone tgl_dokumen " placeholder="dd-mm-yyyy">
                            ...
                            <div class="widget-content pad20f">
                                ...
                                <div class="form-group {{ $errors->has('skpd') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">                                                                     
                                        <select required="" class="form-control" name="skpd" id="skpd">
                                            ...
                                            <option value="6" @if (old('skpd')=='6'||$sppsb->skpd=='6') selected @endif>SKPD Tingkat I NTB</option>
                                            <option value="7" @if (old('skpd')=='7'||$sppsb->skpd=='7') selected @endif>SKPD Tingkat II MATARAM</option>
                                            <option value="8" @if (old('skpd')=='8'||$sppsb->skpd=='8') selected @endif>SKPD Tingkat II LOTENG</option>
                                            <option value="9" @if (old('skpd')=='9'||$sppsb->skpd=='9') selected @endif>SKPD Tingkat II LOTIM</option>
                                            <option value="10"@if (old('skpd')=='10'||$sppsb->skpd=='10') selected @endif>SKPD Tingkat II KLU</option>
                                            <option value="11"@if (old('skpd')=='11'||$sppsb->skpd=='11') selected @endif>SKPD Tingkat II KSB</option>
                                            <option value="13"@if (old('skpd')=='12'||$sppsb->skpd=='12') selected @endif>SKPD Tingkat II SUMBAWA</option>
                                            <option value="13"@if (old('skpd')=='13'||$sppsb->skpd=='13') selected @endif>SKPD Tingkat II DOMPU</option>
                                            <option value="14"@if (old('skpd')=='14'||$sppsb->skpd=='14') selected @endif>SKPD Tingkat II KAB. BIMA</option>
                                            <option value="15"@if (old('skpd')=='15'||$sppsb->skpd=='15') selected @endif>SKPD Tingkat II KOTA BIMA</option>
                                            <option value="16"@if (old('skpd')=='16'||$sppsb->skpd=='16') selected @endif>SKPD Tingkat II LOBAR</option>
                                            <option value="17"@if (old('skpd')=='17'||$sppsb->skpd=='17') selected @endif>INSTANSI VERTIKAL/APBN</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div id="fasilitas" class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="btn-group" data-toggle="buttons">
                                            ...
                                            <label class="btn btn-red  btn-default @if ($sppsb->fasilitas=='Tanpa Uang Muka') active @endif">
...
<script type="text/javascript">
        $(document).ready(function() {
                ...
                @if ($sppsb->jenis_sppsb==1) var li='li:first-child';   $('#spps_type').val('1');@endif
                @if ($sppsb->jenis_sppsb==2) var li='li:nth-child(2)'; $('#spps_type').val('2'); @endif
                @if ($sppsb->jenis_sppsb==3) var li='li:nth-child(3)';  $('#spps_type').val('3');@endif
                @if ($sppsb->jenis_sppsb==4) var li='li:nth-child(4)'; $('#spps_type').val('4'); @endif
                @if ($sppsb->jenis_sppsb==5) var li='li:nth-child(5)'; $('#spps_type').val('5'); @endif
                @if ($sppsb->jenis_sppsb==6) var li='li:nth-child(6)'; $('#spps_type').val('6'); @endif
               
               var jenis =  $('#spps_type').val(); 
...
//$('#jmlTermin').addClass('hide');
        ...
        $('#history_penjaminan').addClass('hide');
           ...
           //tambahan untuk kondisi jika penjaminan sebelumnya dilakukan di jamkirda
            ...
            var radioValue = $("input[name='pialang']:checked").val();
                         if(radioValue=='Ya'){
                                   ActionYa();
                        }else{
                                   ActionTidak();
            ...
            var radioValue = $("input[name='pengerjaan_proyek']:checked").val();
                         if(radioValue=='Ya'){
