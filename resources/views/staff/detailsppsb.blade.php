           ...
           <!--                                      <td> Rp. <span class="numeric">{{ $data->nilai_jaminan }}</span></td>-->
                        ...
                        <div class="widget-content pad20f">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    $gross = $charge - ($materai+$feeAdmin);
                                    $fee_agen = $gross*$fee/100;
                                    
                                    ?>
                                    <p class="form-control-static">Rp. <span class="numeric">{{ $gross }}</span> (<code>{{ucwords(terbilang($gross))}} Rupiah</code>)</p>
                                </div>
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <p class="form-control-static">Rp. <span class="numeric">{{ $fee_agen }}</span> (<code>{{ucwords(terbilang($fee_agen))}} Rupiah</code>)</p>
                                </div>
                            </div><div class="form-group">
                                <label class="col-sm-3 control-label"><strong>Net IJP (Gross - Fee)</strong></label>
                                <div class="col-sm-9">
                                    <p class="form-control-static">Rp. <span class="numeric">{{ $gross-$fee_agen }}</span> (<code>{{ucwords(terbilang($gross-$fee_agen ))}} Rupiah</code>)</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><strong>Service Charge (Gross+Admin+Materai)</strong></label>
                                <div class="col-sm-9">
                       ...
                       @endif
                                        ...
                                        <div id="deskripsiClone">
                                            <div id="cloneWrapperDeskripsi">
                                                ...
                                                <div class="form-group {{ $errors->has('deskripsi') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea required class="form-control clearClone deskripsi" name="deskripsi[]" rows="3">{{ old('deskripsi') }}</textarea>
                                                    </div> 
                                                </div>
                                            </div>   
                                        </div>
                        ...
                        <div class="widget-content pad20f">
                            <div class="form-group {{ $errors->has('referensi') ? ' has-error' : '' }}">
                                <label for="deskripsi" class="col-sm-3 control-label">Referensi<span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <input class="form-control" width="100%"  type="input" name="referensi" required="" >
                                </div>
                            </div>
                            
                            
                          
<!--                            <div class="form-group {{ $errors->has('spesial_case') ? ' has-error' : '' }}">
                                    <label class="col-sm-3 control-label">Special Case <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <div class="btn-group" data-toggle="buttons">
                                            <label id="labelYa"  class="btn btn-blue btn-default @if (old('spesial_case')=='ya') active @endif">
                                                <input  id="ya" type="radio" name="spesial_case" value="ya" @if (old('spesial_case')=='ya') checked @endif autocomplete="off">
                                                        Ya
                                            </label>
                                            <label id="labelTidak" class="btn btn-red btn-default @if (old('spesial_case')=='tidak') active @endif">
                                                <input id='tidak' type="radio" name="spesial_case" value="tidak" @if (old('spesial_case')=='tidak') checked @endif autocomplete="off">
                                                       Tidak
                                            </label>
                                        </div>
                                        <span class="help-block"><small>Jika anda memilih ya maka <b>Service Charge </b>akan di set menjadi <b>Rp. 70.000,- </b></small></span>
                                    </div>
                                </div>-->
                          
                            
                             <!--<div id="pembayaran" class="form-group @if (old('jenis')!='2') hide @endif">-->
                             <div id="special_rate" class="form-group ">
                                    <label class="col-sm-3 control-label">Special Case</label>
                                    <div class="col-sm-9">
                                        <div class="btn-group" data-toggle="buttons">
                                            <label class="btn btn-blue btn-default @if (old('special_rate')=='Ya') active @endif">
                                                <input id="special_rate_yes" type="radio" name="special_rate" value="Ya" @if (old('special_rate')=='Ya') checked @endif autocomplete="off">
                                                       Set Rate
                                            </label>
                                            <label class="btn btn-red  btn-default @if (old('special_rate')=='Tidak') active @endif">
                                                <input id="special_rate_no" type="radio" name="special_rate" value="Tidak" @if (old('special_rate')=='Tidak') checked @endif autocomplete="off">
                                                       Set Service Charge
                                            </label>
                                        </div>
                             ...
                             <div id="jmlRate" class="form-group hide">
                                    <label for="jml_rate" class="col-sm-3 control-label">Rate</label>
                                    <div class="col-sm-2">
                                        <div class="input-group">
                                            <input type="number" name="jml_rate" value="{{ old('jml_rate')}}" class="form-control text-right" id="jml_rate" placeholder="0">
                                            <span class="input-group-addon">%</span>
                                        </div>
                                    </div>
                                </div> 
                             <div id="jmlServiceCharge" class="form-group hide">
                                    <label for="jml_sc" class="col-sm-3 control-label">Service Charge (Rp.)</label>
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="text" name="service_charge" value="{{ old('service_charge') }}" class="form-control text-right numeric"  id="service_charge" placeholder="0">
                                            <span class="input-group-addon"></span>
                                        </div>
                                    </div>
                                </div> 
                        ...
                        <div class="widget-content pad20">
                            ...
                            <div class="alert alert-warning">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <h4><i class="fa fa-warning"></i> CATATAN KABAG:</h4> {{ $analisa->analisa_kabag }}
                            </div>
                             @endif
                        </div>
...
//               $('#customLoad').show(); 
                    ...
                    $('#sppsb_status').val('K'); //menigirim pengajuan ke kabag
                      var servicecharge = parseFloat($('#service_charge').autoNumeric('get')) || 0;
...
$('input:radio[name=special_rate]').change(function () {
        if (this.value == 'Ya')
        {
            $('#jmlRate').removeClass('hide');
            $('#jmlServiceCharge').addClass('hide');
        }
        else
        { 
            $('#jmlServiceCharge').removeClass('hide');
            $('#jmlRate').addClass('hide');
            $('#jmlRate').find('input').val('');
        }
});
