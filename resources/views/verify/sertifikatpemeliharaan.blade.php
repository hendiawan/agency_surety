...
<head>
    ...
    <title>Detail Sertifikat Surety Bond</title>
    <style type="text/css">
				...
				<div class="col-sm-12">
					...
					<div style="height:8px">
                                             <h3 align="center" style="font-size:20px;"><strong>JAMINAN PEMELIHARAAN</strong></h3>
                                                                                   ...
                                                                                   <img align="right" src= "data:image/png;base64,{{ base64_encode(QrCode::format('png')->size(100)->merge('images/jamkrida.png', 0.3, true)->generate('https://demo.jamkridantb.com/sb-detail/'.$sppsb->id))}} ">
                                                                                   <!--<img align="right" src= "data:image/png;base64,{{ base64_encode(QrCode::format('png')->size(100)->merge('images/jamkrida.png', 0.3, true)->generate('https://demo.jamkridantb.com/sppsb-detail/'.md5(base64_encode($sppsb->id))))}} ">-->
                                        <br>
                                        <br>
                                        <br>
                                        <br>
