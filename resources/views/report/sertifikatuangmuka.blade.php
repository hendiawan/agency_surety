                        ...
                        <div class="col-sm-12">
                            ...
                            <ol class="sertifikat-list">
                                ...
                                <li class="text-justify">Maka kami, <strong>TERJAMIN</strong> dan <strong>PENJAMIN</strong> dengan ini mengikatkan diri 
                                    ...
                                    memenuhi kewajibannya dalam melaksanakan pekerjaan <strong>{{ $sppsb->jenis_pekerjaan }}</strong> 
                                    yang telah di tetapkan dalam kontrak Nomor : <strong>{{ $sppsb->no_dokumen }}</strong> tanggal {{ tgl_indo($sppsb->tgl_dokumen) }} dari
                                ...
                                <li class="text-justify">Jaminan ini berlaku apabila <strong>TERJAMIN</strong> tidak memenuhi kewajibannya melakukan pembayaran kembali kepada
                                    <strong>PENERIMA JAMINAN</strong> senilai uang muka dimaksud yang wajib dibayar menurut Kontrak.
                                </li>
