                        ...
                        <div class="col-sm-12">
                            ...
                            <ol class="sertifikat-list">
                                <li class="text-justify">Dengan ini dinyatakan bahwa kami <span class="text-uppercase"><strong>{{ $sppsb->nama_kontraktor }}</strong></span>
                                    ...
                                    <strong>PENJAMIN</strong>, bertanggung jawab dan dengan tegas terikat pada <span class="text-uppercase"><strong>{{ $sppsb->jabatan_pejabat }} {{ $sppsb->pemilik_proyek }} {{ $sppsb->pemilik_proyek }} {{ $sppsb->alamat }}</strong></span> 
                                ...
                                <li class="text-justify">Surat jaminan ini berlaku apabila <strong>TERJAMIN</strong>;
                                    <ol type="a">
                                          <li>Terlibat Korupsi, Kolusi dan/ atau Nepotisme (KKN)</li>
                                        <li>Menarik kembali penawarannya selama dilaksanakannya tender.</li>
                                        <li>Tidak:
                                            <ol> 
                                                <li>Bersedia menambah nilai jaminan pelaksanaan dalam hal sebagai calon pemenang cadangan
                                                1 dan 2 harga penawarannya di bawah 80% HPS 
                                                </li> 
                                                <li>Hadir dalam klarifikasi dan/atau verifikasi sebagai calon pemenang.</li> 
                                            </ol>
                                        </li>
                                           <li>Menundurkan diri atau gagal tanda tangan kontrak</li>
                                    </ol>
                                </li>
