                ...
                <div class="widget-content pad20f">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <!--<img align="right" src= "data:image/png;base64,{{ base64_encode(QrCode::format('png')->size(100)->merge('images/jamkrida.png', 0.35, true)->generate('https://demo.jamkridantb.com/sppsb-detail/'.md5(base64_encode($sppsb->id))))}} ">-->
                            <br>
                            <br>
                            <br>
                            <br>
                            ...
                            <ol class="sertifikat-list">
                                ...
                                <li class="text-justify">Maka kami, <strong>TERJAMIN</strong> dan <strong>PENJAMIN</strong> dengan ini mengikatkan diri 
                                    ...
                                    memenuhi kewajibannya dalam melaksanakan pekerjaan  sebagaimana ditetapkan berdasarkan Surat Penunjukkan
                                    Penunjukkan Penyedia Barang/ Jasa Nomor.: <strong>{{ $sppsb->no_dokumen }}</strong> 
                                    tanggal {{ tgl_indo($sppsb->tgl_dokumen) }} untuk pelaksanaan  pekerjaan <strong>{{ $sppsb->jenis_pekerjaan }}</strong>
                                    yang diselenggarakan oleh <strong>PENERIMA JAMINAN</strong>
                                </li>
