...
@section('content')
	<div id="main" class="clearfix">
		<div class="secInfo">
			<h1 class="secTitle">Form Input SP3 KBG</h1>
			<span class="secExtra">Form penginputan/pengisian Surat Persetujuan Prinsip Penjaminan (SP3) Kontra Bank Garansi</span>
		</div> <!-- /SecInfo -->
		<div class="fluid">				
				...
				<div class="topTabs">					
					<div id="topTabs-container-form">
							...
							<ul class="etabs tabs">
								<li class="tab">
									<a href="#tab1" class="penawaran">
										...
										<i class="fa icon-hidden fa-tag" data-toggle="tooltip" data-placement="bottom" title="SP3 KBG Type Penawaran"></i>
									</a>
								</li>
								<li class="tab">
									<a href="#tab2" class="pelaksanaan">
										...
										<i class="fa icon-hidden fa-play" data-toggle="tooltip" data-placement="bottom" title="SP3 KBG Type Pelaksanaan"></i>
									</a>
								</li>
								<li class="tab">
									<a href="#tab3" class="uangMuka">
										...
										<i class="fa icon-hidden fa-money" data-toggle="tooltip" data-placement="bottom" title="SP3 KBG Type Uang Muka"></i>
									</a>
								</li>
								<li class="tab">
									<a href="#tab4" class="pemeliharaan">
										...
										<i class="fa icon-hidden fa-wrench" data-toggle="tooltip" data-placement="bottom" title="SP3 KBG Type Pemeliharaan"></i>
									</a>
								</li>
								<li class="tab">
									<a href="#tab5" class="pembayaran">
										...
										<i class="fa icon-hidden fa-money" data-toggle="tooltip" data-placement="bottom" title="SP3 KBG Type Pembayaran"></i>
									</a>
								</li>
								<li class="tab">
									<a href="#tab6" class="sanggahBanding">
										...
										<i class="fa icon-hidden fa-gavel" data-toggle="tooltip" data-placement="bottom" title="SP3 KBG Type Sanggah Banding"></i>
									</a>
								</li>
							</ul> <!-- /tabs -->
						</div><!-- /topTabs-header -->
						...
						<div class="topTabsContent" style="padding-left:0;">
							...
							<form id="sp3kbgForm" class="form-horizontal" method="POST" action="{{ url('/') }}/sp3kbg-form" enctype="multipart/form-data">
							{!! csrf_field() !!}
								<input type="hidden" id="sp3kbg_type" name="jenis" value="{{ old('jenis', 1) }}">
									...
									<div class="form-group {{ $errors->has('jabatan_direksi') ? ' has-error' : '' }}">
										...
										<div class="col-sm-9">
											<div class="btn-group" data-toggle="buttons">
												<label class="btn btn-blue btn-default @if (old('jabatan_direksi')=='Direktur') active @endif">
													<input type="radio" name="jabatan_direksi" value="Direktur" @if (old('jabatan_direksi')=='Direktur') checked @endif autocomplete="off">
													Direktur
												</label>
												<label class="btn btn-turquoise btn-default @if (old('jabatan_direksi')=='Direktris') active @endif">
													<input type="radio" name="jabatan_direksi" value="Direktris" @if (old('jabatan_direksi')=='Direktris') checked @endif autocomplete="off">
													Direktris
												</label>
												<label class="btn btn-yellow btn-default @if (old('jabatan_direksi')=='Kuasa Direktur') active @endif">
													<input type="radio" name="jabatan_direksi" value="Kuasa Direktur" @if (old('jabatan_direksi')=='Kuasa Direktur') checked @endif autocomplete="off">
													Kuasa Direktur
												</label>
												<label class="btn btn-orange btn-default @if (old('jabatan_direksi')=='Kuasa Direktris') active @endif">
													<input type="radio" name="jabatan_direksi" value="Kuasa Direktris" @if (old('jabatan_direksi')=='Kuasa Direktris') checked @endif autocomplete="off">
													Kuasa Direktris
												</label>
											</div>
									...
									<div class="form-group {{ $errors->has('bank') ? ' has-error' : '' }}">
										...
										<div class="col-sm-9">
											<select name="bank" class="form-control" id="bank">
												...
												<option value="{{$item->id}}">{{$item->name}} ({{$item->wilayah}})</option>
												@endforeach
											</select>
										</div>
									</div>
								...
								<div class="widget-content pad20f">						
									...
									<div class="alert alert-info" role="alert">
										...
										<ul style="padding-left: 20px !important;">
											...
											<li>Klik tombol <code>Kembali</code> jika anda batal melakukan penginputan data SP3 KBG</li>
											<li>Klik tombol <code>Proses</code> untuk menyimpan data SP3 KBG yang sudah anda inputkan. Data yang anda inputkan akan berstatus "DRAFT", sehingga masih dapat dilakukan pengeditan kembali sebelum diajukan kepada staff surety bond</li>
										</ul>
									</div>
								</div>							
							</form>	
